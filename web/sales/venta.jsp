...
<table border =1>
    <tr><td>고객 아이디</td> <td>고객명</td> <td>상품명</td> <td>수량</td> <td>판매일</td> <td>배송상태</td> </tr>
    <c:forEach items="${list }" var="dto">
        <tr><td>
            ...
            <td>${dto.purchaseDate }</td><%@ page language="java" contentType="text/html; charset=UTF-8"
                                                  pageEncoding="UTF-8"%>
            <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
            <!DOCTYPE html>
            <html>
            ...
            <td>
                <a href="createDelivery.vnt?purchaseNum=${dto.purchaseNum}">  </a>
                <c:if test="${dto.deliveryNum == null}"></c:if>
                <c:if test="${dto.deliveryNum != null}"></c:if>
            </td>
        </tr>
    </c:forEach>
